...
At BU, I work with the support and mentorship of Dr. [Swathi Kiran](https://www.bu.edu/sargent/profile/swathi-kiran-ph-d-ccc-slp/) in the [Center for Brain Recovery](https://www.bu.edu/cbr/). I am co-mentored by Dr. [Einat Liebenthal](https://www.mcleanhospital.org/profile/einat-liebenthal) in the [Functional Neuroimaging & Bioinformatics Lab](https://bakerlab.mclean.harvard.edu) at McLean Hospital. At Johns Hopkins, I will be working with Dr. [Argye E. Hillis](https://score.jhmi.edu/director.html) in the [SCORE (Stroke Cognitive Outcomes & REcovery) Lab](https://score.jhmi.edu/index.html).
