...
Language disorders are among the most common and consequential sequelae of stroke and other neurological conditions, yet the tools used to assess and predict recovery remain limited. My work is concerned with improving the lives of those affected, by building predictive models that inform how and when to intervene, designing assessments that look beyond a single severity score, and accounting for the individual differences that shape recovery. Read more on the [research](research) page.
