...
My research foci lie along two (sometimes converging) lines. First, I aim to generate actionable insights about bi- and multilingual aphasia, with a particular emphasis on Hispanic/Latinx populations facing communication disorders. Second, I am developing a cross-modal understanding of aphasia by examining how impairments in language processing can influence processing in other domains. In both cases, I use computational approaches, applying advanced data analytic techniques to bridge controlled laboratory studies and real-world language use.
